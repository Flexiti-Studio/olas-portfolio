  ...
  return (
    <section className="w-full mt-10 bg-[#f5f6f8] dark:bg-[#0c1018] py-20 px-4 md:px-10 border-t border-[#e5e7eb] dark:border-[#222f49]" id="contact">
      <div className="max-w-[800px] mx-auto text-center flex flex-col items-center gap-8">
        ...
        <Link className="inline-flex items-center gap-3 text-2xl md:text-3xl font-bold text-primary hover:text-blue-400 transition-colors border-b-2 border-primary/30 hover:border-primary pb-1" href="mailto:olasunkanmiola531@gmail.com">
          olasunkanmiola531@gmail.com
        </Link>

        <Link className="inline-flex items-center justify-center h-14 px-8 rounded-xl bg-primary hover:bg-blue-600 text-white font-bold text-base transition-all shadow-[0_0_20px_rgba(13,89,242,0.3)] hover:shadow-[0_0_30px_rgba(13,89,242,0.5)] hover:-translate-y-1 mt-2" href="/contact">
          Contact Now
        </Link>

        <div className="flex items-center gap-6 mt-4">
          <Link className="p-3 rounded-full bg-white dark:bg-[#1a2332] text-[#637588] dark:text-[#90a4cb] hover:scale-110 hover:text-primary dark:hover:text-primary transition-all shadow-md" href="https://www.instagram.com/flexitistudio/" target="_blank" rel="noopener noreferrer">
          ...
          <Link className="p-3 rounded-full bg-white dark:bg-[#1a2332] text-[#637588] dark:text-[#90a4cb] hover:scale-110 hover:text-primary dark:hover:text-primary transition-all shadow-md" href="https://www.linkedin.com/company/flexbit-studio" target="_blank" rel="noopener noreferrer">
          ...
          <Link className="p-3 rounded-full bg-white dark:bg-[#1a2332] text-[#637588] dark:text-[#90a4cb] hover:scale-110 hover:text-primary dark:hover:text-primary transition-all shadow-md" href="https://github.com/nicxd531" target="_blank" rel="noopener noreferrer">
          ...
          <Link className="p-3 rounded-full bg-white dark:bg-[#1a2332] text-[#637588] dark:text-[#90a4cb] hover:scale-110 hover:text-primary dark:hover:text-primary transition-all shadow-md" href="https://x.com/FlexitiStudio" target="_blank" rel="noopener noreferrer">
