    ...
    <section className="w-full mt-10 bg-[#f5f6f8] dark:bg-[#0c1018] py-20 px-4 md:px-10 border-t border-[#e5e7eb] dark:border-[#222f49]" id="contact">
      <div className="max-w-[800px] mx-auto text-center flex flex-col items-center gap-8">
        ...
        <div className="flex items-center gap-6 mt-4">
          <Link className="p-3 rounded-full bg-white dark:bg-[#1a2332] text-[#637588] dark:text-[#90a4cb] hover:scale-110 hover:text-primary dark:hover:text-primary transition-all shadow-md" href="https://www.instagram.com/nicx_ola/" target="_blank" rel="noopener noreferrer">
          ...
          <Link className="p-3 rounded-full bg-white dark:bg-[#1a2332] text-[#637588] dark:text-[#90a4cb] hover:scale-110 hover:text-primary dark:hover:text-primary transition-all shadow-md" href="https://www.linkedin.com/in/ola-olasunkanmi/" target="_blank" rel="noopener noreferrer">
          ...
          <Link className="p-3 rounded-full bg-white dark:bg-[#1a2332] text-[#637588] dark:text-[#90a4cb] hover:scale-110 hover:text-primary dark:hover:text-primary transition-all shadow-md" href="https://x.com/nicx_ola_" target="_blank" rel="noopener noreferrer">
